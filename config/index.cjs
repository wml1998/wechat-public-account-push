  ...
  USERS: [
    {
      ...
      useTemplateId: 'VIE-U-Ka712PDms6N5q3Xs66Wf-zOJFRErjPUU26Azg',
      ...
      festivals: [
        ...
        {
          type: '节日', name: '开始日', year: '2023', date: '02-14',
        },
      ],
      // 我们在一起已经有xxxx天了的配置
      customizedDateList: [
...
//         { keyword: 'marry_day', date: '2022-09-09' },
  ...
  CALLBACK_TEMPLATE_ID: 'VIE-U-Ka712PDms6N5q3Xs66Wf-zOJFRErjPUU26Azg',
